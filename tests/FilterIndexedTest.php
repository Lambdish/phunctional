...
final class FilterIndexedTest extends TestCase
{
    /** @test */
    public function it_should_filter_a_collection_keeping_the_indexes(): void
    {
        ...
        $this->assertSame(['two' => 2, 'four' => 4], filter_indexed($pred, $actual));
    }
    ...
    public function it_should_filter_a_collection_using_their_keys(): void
    {
        ...
        $this->assertSame([2 => 'two', 4 => 'four'], filter_indexed($pred, $actual));
    }
