...
final class FlatMapIndexedTest extends TestCase
{
    /** @test */
    public function it_should_apply_and_then_flatten(): void
    {
        ...
        $this->assertSame($expected, flat_map_indexed($naturalRange, $actual));
    }
    ...
    public function it_should_allow_receive_the_key_in_the_function_to_apply(): void
    {
        ...
        $this->assertSame($expected, flat_map_indexed('range', $actual));
    }
}
